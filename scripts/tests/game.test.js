...
describe("newGame works correctly", () => {
    ...
    // });
    test("should be one move in the cmputer's game array", () => {
...
describe("gameplay works correctly", () => {
    // Set up the game state.  Before each runs before each test is run, so we're going to reset the state each time
    beforeEach(() => {
        game.score = 0;
        game.currentGame = [];
        game.playerMoves = [];
    ...
    // Our tests are going to modify the game state. The test should be isolated i.e. they should be able to run in any order
    // so we reset the game state again after each test
    afterEach(() => {
        game.score = 0;
        game.currentGame = [];
        game.playerMoves = [];
